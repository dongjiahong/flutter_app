...
class BottomAppBarScreen extends StatefulWidget {
  @override
  createState() => BottomAppBarState();
}

class BottomAppBarState extends State<BottomAppBarScreen> {
  ...
  static const _ChoiceValue<FloatingActionButtonLocation> kFabEndFloat =
      const _ChoiceValue<FloatingActionButtonLocation>(
    title: 'Attached - End',
    label: 'floating action button is above at the end of the bottom app bar',
  ...
  static const _ChoiceValue<FloatingActionButtonLocation> kFabCenterFloat =
    ...
    title: 'Attached - Center',
    label:
        'floating action button is float above at the end of the bottom app bar',
  ...
  static void _showSnackbar() {
    const String text =
        ...
        'the floating action button animates to its new postition.'
        'The BottomAppBar adapts its shape appropriately.';

    // Scaffold.of(context).showSnackBar(const SnackBar(content: const Text(text)));
    _scaffoldKey.currentState.showSnackBar(const SnackBar(content: const Text(text)));
  }
...
class _DiamondNotchedRectangle implements NotchedShape {
  ...
  Path getOuterPath(Rect host, Rect guest) {
    if (!host.overlaps(guest)) return new Path()..addRect(host);
